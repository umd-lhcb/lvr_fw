...
# Tue Jan 15 16:06:07 2019

# (NEW DESIGN)

# create a new design
new_design -name "IIR_FILT" -family "ProASIC3"

# set default back-annotation base-name
set_defvar "BA_NAME" "IIR_FILT_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "IIR_FILT.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VHDL" {../../synthesis/IIR_FILT.edn}

# export translation of original netlist
export -format "vhdl" {../../synthesis/IIR_FILT.vhd}
